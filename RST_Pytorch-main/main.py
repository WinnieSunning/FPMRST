...
def train(args, io):
    ...
    for epoch in range(args.epochs):
        ...
        # train_acc = np.array(metrics.accuracy_score(train_true, train_pred))
        ...
        # np.save('checkpoints/loss1/epoch_{}'.format(epoch),Loss0)
        # np.save('checkpoints/accrough/epoch_{}'.format(epoch), train_acc)
        io.cprint(outstr)
